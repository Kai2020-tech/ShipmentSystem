...
import com.example.shipmentsystem.databinding.ItemProductBinding
import com.example.shipmentsystem.db.Product

class RvProductAdapter : RecyclerView.Adapter<RvProductAdapter.MyHolder>() {
    ...
    inner class MyHolder(binding: ItemProductBinding) : RecyclerView.ViewHolder(binding.root) {
